...
**NB** В BEM-XJST хелперы `apply` и `applyNext` вместо опрераций присвоения могут принимать строку или приводимое к ней выражение. Это означает «выставить указанную строку в качестве моды».
